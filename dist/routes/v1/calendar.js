...
exports.calendarRouter.put("/:id", middleware_1.middleware, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.calendarRouter.delete("/:id", middleware_1.middleware, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const booking = yield src_1.default.booking.findFirst({
            where: {
                id: req.params.id,
...
exports.calendarRouter.put("/change-color/:id", middleware_1.middleware, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
