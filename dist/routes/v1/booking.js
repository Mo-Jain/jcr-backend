...
exports.bookingRouter.post("/", middleware_1.middleware, (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      if (!customerId || customerId === 0) {
        const folder = yield (0, folder_1.createFolder)(
...
exports.bookingRouter.get("/all", middleware_1.middleware, (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
...
exports.bookingRouter.get("/:id", middleware_1.middleware, (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
...
exports.bookingRouter.put(
  "/delete-multiple",
  middleware_1.middleware,
  (req, res) =>
    __awaiter(void 0, void 0, void 0, function* () {
      console.log("Request body:", req.body);
      const parsedData = types_1.MultipleBookingDeleteSchema.safeParse(
        req.body,
      );
      if (!parsedData.success) {
...
exports.bookingRouter.put("/:id", middleware_1.middleware, (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
exports.bookingRouter.put("/:id/start", middleware_1.middleware, (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
exports.bookingRouter.put("/:id/end", middleware_1.middleware, (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
exports.bookingRouter.delete("/:id", middleware_1.middleware, (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const booking = yield src_1.default.booking.findFirst({
        where: {
      ...
      if (booking.carImages.length > 0) {
        yield (0, delete_1.deleteMultipleFiles)(
...
exports.bookingRouter.post("/multiple", middleware_1.middleware, (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
