...
exports.router.post("/signup/se23crt1", (req, res) =>
...
exports.router.get("/me", middleware_1.middleware, (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const user = yield src_1.default.user.findFirst({
        where: {
...
exports.router.get("/me/name", middleware_1.middleware, (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const user = yield src_1.default.user.findFirst({
        where: {
...
exports.router.put("/me", middleware_1.middleware, (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
